...
f_train_data = open('../data/spatial/cdc_conva_path_train01.txt')
f_test_data = open('../data/spatial/cdc_conva_path_test01.txt')
    ...
    for index, line in enumerate(data.readlines()):
        ...
        for fc in file_list:
            if os.path.splitext(fc)[1] == '.conv5b':
                ...
                save_path = fc_path.replace("/home/zsl/dataset/cdc_16_feature", "/media/zsl/fengzy/CDC-Feature-16")
                print save_path
                np.save(save_path, a)
